        ...
        <div className="min-h-screen bg-gray-50 flex flex-col justify-between">
            ...
            <div className="fixed bottom-20 right-3 sm:bottom-4 sm:right-4 z-30">
                <a
                    ...
                    className="flex items-center gap-1.5 bg-yellow-400 hover:bg-yellow-500 text-black px-2.5 py-1.5 rounded-full shadow-lg transition-colors duration-200 text-xs font-medium"
                >
                    <svg width="20" height="29" viewBox="0 0 27 39" fill="none" xmlns="http://www.w3.org/2000/svg">
